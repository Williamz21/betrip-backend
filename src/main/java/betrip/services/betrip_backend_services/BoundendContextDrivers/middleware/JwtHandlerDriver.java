...
@Component
public class JwtHandlerDriver {
    private static final Logger logger = LoggerFactory.getLogger(JwtHandlerDriver.class);
    ...
    public String generateToken(Authentication authentication) {
        ...
        String subject = ((DriverDetailImpl) authentication.getPrincipal()).getUsername();
