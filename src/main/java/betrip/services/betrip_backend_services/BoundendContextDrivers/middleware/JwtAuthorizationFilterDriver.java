...
import betrip.services.betrip_backend_services.BoundendContextDrivers.service.DriverServiceImpl;
...
public class JwtAuthorizationFilterDriver extends OncePerRequestFilter {

    private static final Logger logger = LoggerFactory.getLogger(JwtAuthorizationFilterDriver.class);

    @Autowired
    private JwtHandlerDriver handler;
