...
@Component
public class JwtAuthenticateEntryPointTraveler implements AuthenticationEntryPoint {
    private static final Logger logger = LoggerFactory.getLogger(JwtAuthenticateEntryPointTraveler.class);
