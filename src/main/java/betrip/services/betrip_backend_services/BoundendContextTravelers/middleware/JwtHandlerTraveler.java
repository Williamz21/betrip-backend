...
@Component
public class JwtHandlerTraveler {
    private static final Logger logger = LoggerFactory.getLogger(JwtHandlerTraveler.class);
    ...
    public String generateToken(Authentication authentication) {
        ...
        String subject = ((TravelerDetailImpl) authentication.getPrincipal()).getUsername();
