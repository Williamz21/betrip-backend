...
import betrip.services.betrip_backend_services.BoundendContextTravelers.service.TravelerServiceImpl;
...
public class JwtAuthorizationFilterTraveler extends OncePerRequestFilter {
    private static final Logger logger = LoggerFactory.getLogger(JwtAuthorizationFilterTraveler.class);

    @Autowired
    private JwtHandlerTraveler handler;

    @Autowired
    private TravelerServiceImpl userService;
