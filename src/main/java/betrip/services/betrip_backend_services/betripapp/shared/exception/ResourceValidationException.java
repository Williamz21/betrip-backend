package betrip.services.betrip_backend_services.betripapp.shared.exception;
...
public class ResourceValidationException extends RuntimeException{
    ...
    public <T> ResourceValidationException(String resourceName, Set<ConstraintViolation<T>> violations){
        super(String.format("Not all Constraints satisfied for %s: %s ",resourceName,violations
                .stream()
                .map(
                        violation->String.format("%s %s",
